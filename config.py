...
if not all([WP_API_URL, WP_USERNAME, WP_PASSWORD, OPENAI_API_KEY, BLUESKY_HANDLE, MASTODON_BASE_URL, BLUESKY_APP_PASSWORD, MASTODON_ACCESS_TOKEN]):
    raise ValueError(
        "Fehlende Umgebungsvariablen! "
        "Benötigt: WP_API_URL, WP_USERNAME, WP_PASSWORD, OPENAI_API_KEY, BLUESKY_HANDLE, MASTODON_BASE_URL, BLUESKY_APP_PASSWORD, MASTODON_ACCESS_TOKEN "
